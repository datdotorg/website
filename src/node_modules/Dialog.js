...
function Dialog({panel, current, ver, package }, protocol) {
    const css = style
    // icons
    ...
    <div class=${css.overlay}>
        <div class=${css.dialog}>
            ...
            <div class=${css["dialog-body"]}>
                ...
                <p class=${css.message}> ${package.title} v${ver} will be removed.</p>
            </div>
    ...
    function actionHandler(target) {
        ...
        if (target === 'cancel') 
            console.log(`${package.title} v${ver} cancel remove`);
    }
}
